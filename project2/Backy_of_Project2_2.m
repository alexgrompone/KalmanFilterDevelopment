% EC 3310 Computer Assignment #2 Part2
...
%Estimating covarinace in cartesian
   Fx=[cos(zpolar(2)), -zpolar(1)*sin(zpolar(2));
       sin(zpolar(2)), zpolar(1)*cos(zpolar(2))];
 ...
 %State vector estimate
    ...
    M=[M;H*(K^(2*(ii-1)+1))];
    W=[W,zeros(max(size(W)),2);zeros(2,max(size(W))),S1vcv];

%    W=inv([S1vcv,zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2);
%    zeros(2),S1vcv,zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2);
%    zeros(2),zeros(2),S1vcv,zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2);
%    zeros(2),zeros(2),zeros(2),S1vcv,zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2);
%    zeros(2),zeros(2),zeros(2),zeros(2),S1vcv,zeros(2),zeros(2),zeros(2),zeros(2),zeros(2);
%    zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),S1vcv,zeros(2),zeros(2),zeros(2),zeros(2);
%    zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),S1vcv,zeros(2),zeros(2),zeros(2);
%    zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),S1vcv,zeros(2),zeros(2);
%    zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),S1vcv,zeros(2);
%    zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),zeros(2),S1vcv]);
%     

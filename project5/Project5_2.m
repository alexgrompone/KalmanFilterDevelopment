...
%Measurement Update
sqx=(Xxf(1)^2)+(Xxf(3)^2);
Hk=[Xxf(1)/(sqrt(sqx)) 0 Xxf(3)/(sqrt(sqx)) 0;
    -Xxf(3)/sqx 0 Xxf(1)/sqx 0];
...
%Correction 
Xk1_k1=Xxf + Kk1*(Ztk1);
Pk1_k1=(eye(4)-Kk1*Hk)*Pk1_k*(eye(4)-Kk1*Hk)' + Kk1*S1v*Kk1';
